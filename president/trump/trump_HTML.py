...
if __name__ == '__main__':
    ...
    output_file_html = open('../../../result/trump/trump_output_html3.txt', 'w+', encoding="utf8")
    count = 0
    for line in open('../../../result/trump/trump_output_html1.txt', 'r', encoding='utf8'):
        line = line.replace('\n', '')
        count += 1
        ...
        for p_tag in p_tag_list:
            etree.strip_tags(p_tag, 'strong', 'u', 'b', 'span', 'em')
            ...
            for children in all_direct_children:
                ...
                if children.tag == "a":
                    ...
                    br_text = ';;;;' + children_text + children_tail + ';;;;'
                    p_text += br_text
                else:
        ...
        output_line = output_line.replace('\u202f', '').replace('\xa0', '').replace(';;;;;;;;', ';;;;')
