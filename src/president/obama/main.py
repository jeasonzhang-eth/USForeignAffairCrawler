...
def process4content_extractor(element: Element, date_):
...
def get_obama_day_url(filename):
    ...
    for month_url in month_url_list:
        ...
        bh.open(month_url)
        link_elements = bh.find_elements((By.XPATH, '//div[@class="l-wrap"]//a'))
...
if __name__ == '__main__':
    ...
    #     process4content_extractor(original_element, date)
    #
